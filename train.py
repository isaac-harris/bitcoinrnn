...
# img=cv2.imread("/home/danhyal/bigoof.jpg")
# img=cv2.cuda_GpuMat(img)
# img=cv2.cuda.cvtColor(img,cv2.COLOR_BGR2RGBA)
# new_img=img.download()
# video=cv2.VideoCapture("/home/danhyal/Zombieland - Double Tap Red Band Trailer #1 (2019) _ Movieclips Trailers-nI9p58_KJmw.mkv")
# print(video.getBackendName())
# while video.isOpened():
#     ret,frame=video.read()
#     frame=cv2.cuda_GpuMat(frame)
#     frame=cv2.cuda.cvtColor(frame,cv2.COLOR_BGR2RGBA)
#     norn=cv2.norm(src1=frame.download())
